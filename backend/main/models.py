...
class Voter(models.Model):
    ...
    election_organizers = models.ForeignKey(Election,blank=True,null=True,on_delete=models.SET_NULL,related_name='organizers') # change the name of field to election
    election_creator = models.OneToOneField(Election,blank=True,null=True,on_delete=models.SET_NULL,related_name='created_by')

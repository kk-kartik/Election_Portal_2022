...
const ProfileNavBar = () => {
    return(
      ...
      <div className="flex">
        ...
        <button className={`${styles.preview} py-1 px-5 ml-4 mr-4`}><span className="flex"><div className="flex items-center mr-1">
         <img src={Eye}/> </div><div className="flex items-center mr-1">Preview</div></span></button>
      </div>
